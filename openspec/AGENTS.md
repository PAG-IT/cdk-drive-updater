...
- Update `README.md` whenever a change affects user-facing behavior, prerequisites, configuration, CLI flags, output/logging, architecture, module responsibilities, tracked software, build commands, or release packaging.
- Update `FUNCTIONALITY.md` whenever a change affects `src/` behavior, public/exported types, functions, constants, data flow, algorithms, configuration sources, target software definitions, log table structures, build scripts, release profile settings, or release packaging.
